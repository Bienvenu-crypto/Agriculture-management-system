    ...
    <div className={!isInline ? "fixed inset-0 z-[200] flex items-center justify-center p-4 overflow-y-auto" : ""}>
      ...
      >
        {!isInline && (
          <button
            onClick={onClose}
            className="absolute top-4 right-4 px-4 py-2 text-[10px] font-black text-slate-400 hover:text-slate-900 capitalize tracking-widest transition-colors"
          >
            Close
          </button>
        )}
        ...
        <div className="p-8">
          ...
          <div className="flex rounded-2xl bg-slate-100 p-1 mb-6">
            {(['seller', 'buyer'] as const).map((r) => (
              <button
                ...
                className={`flex-1 py-3 rounded-xl text-[10px] font-black capitalize tracking-widest capitalize transition-all ${role === r
                  ? r === 'seller'
          ...
          <div className={`flex justify-center mb-4`}>
            <div className={`px-6 py-2 rounded-2xl font-black text-[10px] capitalize tracking-widest ${role === 'seller' ? 'bg-emerald-100 text-emerald-600' : 'bg-blue-100 text-blue-600'}`}>
              {role === 'seller' ? 'Store' : 'Cart'}
            </div>
          </div>

          <h2 className="text-2xl font-black text-center text-slate-900 mb-1 capitalize tracking-tighter">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            {mode === 'signup' && (
              <>
                <div>
                  <label className="block text-xs font-bold text-slate-700 capitalize tracking-wider mb-1.5">Full Name</label>
                  <input
                    type="text"
                    required
                    value={form.name}
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-700 capitalize tracking-wider mb-1.5">District</label>
                  <input
                    type="text"
                    required
                    value={form.district}
            ...
            {error && (
              <div className="p-3 bg-red-50 text-red-600 text-[10px] font-black capitalize tracking-widest rounded-xl flex gap-2 items-center">
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full py-3 rounded-xl font-black capitalize text-[10px] tracking-widest text-white transition-colors flex items-center justify-center gap-2 disabled:opacity-70 ${role === 'seller' ? 'bg-emerald-600 hover:bg-emerald-700' : 'bg-blue-600 hover:bg-blue-700'
                }`}
            >
    ...
    return (
      <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
        ...
        <div className="relative bg-white p-8 rounded-2xl shadow-xl">
          <p className="text-[10px] font-black capitalize tracking-widest text-slate-400 animate-pulse">Verifying Account...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }}
          ...
          <h3 className="text-2xl font-black text-slate-900 capitalize tracking-tighter mb-2">Subscription Required</h3>
          ...
          <div className="space-y-3">
            ...
            <button onClick={onClose} className="w-full text-[10px] font-black capitalize tracking-widest text-slate-400 hover:text-slate-600 transition-colors">Maybe Later</button>
          </div>
        </motion.div>
      </div>
    );
    ...
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
      ...
      <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }}
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-xl font-black text-slate-900 capitalize tracking-tighter">New Listing</h2>
            <p className="text-xs text-slate-500 font-bold capitalize tracking-widest">Post your crop for sale</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-3 gap-3">
            <div className="col-span-2">
              <label className="block text-xs font-bold text-slate-700 capitalize tracking-wider mb-1.5">Crop Name</label>
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 capitalize tracking-wider mb-1.5">Currency</label>
              <select
                value={form.currency}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-bold text-slate-700 capitalize tracking-wider mb-1.5">Quantity (kg)</label>
              <input type="number" required min="0.1" step="0.1" value={form.quantity_kg} onChange={e => setForm({ ...form, quantity_kg: e.target.value })}
                className="w-full bg-slate-50 px-4 py-2.5 rounded-xl focus:ring-2 focus:ring-emerald-500 outline-none text-sm font-bold"
                placeholder="500" />
            </div>
            <div>
              <label className="block text-xs font-bold text-slate-700 capitalize tracking-wider mb-1.5">Price/kg</label>
          ...
          <div>
            <label className="block text-xs font-bold text-slate-700 capitalize tracking-wider mb-1.5">Category</label>
            <select
              value={form.category}
          ...
          <button type="submit" disabled={loading}
            className="w-full bg-emerald-600 text-white py-4 rounded-xl font-black capitalize text-[10px] tracking-widest hover:bg-emerald-700 transition-colors disabled:opacity-70 shadow-lg shadow-emerald-600/20">
    ...
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
      ...
      <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }}
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-xl font-black text-slate-900 capitalize tracking-tighter">Edit Listing</h2>
            <p className="text-xs text-slate-500 font-bold capitalize tracking-widest">Update your crop details</p>
          </div>
        </div>
    ...
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
      ...
      <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }}
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-xl font-black text-slate-900 capitalize tracking-tighter">New Buy Order</h2>
            <p className="text-xs text-slate-500 font-bold capitalize tracking-widest">Request a crop</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 capitalize tracking-wider mb-1.5">Max Price/kg</label>
          ...
          <div>
            <label className="block text-xs font-bold text-slate-700 capitalize tracking-wider mb-1.5">Notes (optional)</label>
            <textarea value={form.description} onChange={e => setForm({ ...form, description: e.target.value })}
          ...
          {error && <div className="p-3 bg-red-50 text-red-600 text-sm rounded-xl">{error}</div>}
          <button type="submit" disabled={loading}
            className="w-full bg-blue-600 text-white py-4 rounded-xl font-black capitalize text-[10px] tracking-widest hover:bg-blue-700 transition-colors disabled:opacity-70 shadow-lg shadow-blue-600/20">
  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        <div className="bg-emerald-100 px-3 py-1.5 rounded-xl text-emerald-600 flex-shrink-0 font-black text-[9px] capitalize tracking-widest">
          Match
        </div>
        <div className="flex-1 min-w-0">
          <p className="font-black text-white text-xs capitalize tracking-tighter">Trade Matched!</p>
          <p className="text-[10px] text-slate-600 mt-1 capitalize tracking-widest leading-loose">
          ...
          <p className="text-[10px] text-emerald-700 font-black mt-1 capitalize tracking-[0.2em]">
            TOTAL VALUE: {trade.currency} {trade.total_value.toLocaleString()}
          </p>
          <div className="mt-3 pt-3 bg-slate-50/50 rounded-xl p-2">
            <p className="text-[9px] font-black text-slate-400 capitalize tracking-widest mb-1.5 leading-none px-1">Contact Intelligence</p>
            <div className="bg-slate-50 rounded-xl px-3 py-1.5">
              <span className="text-[9px] font-black capitalize text-slate-500 tracking-widest block mb-0.5">Seller ID: {trade.seller_name}</span>
              <span className="text-[10px] font-black capitalize text-emerald-600 tracking-tighter block">{trade.seller_phone || 'REDACTED'}</span>
            </div>
          </div>
        </div>
        <button onClick={onDismiss} className="px-3 py-1.5 bg-slate-50 text-[9px] font-black text-slate-400 hover:text-slate-950 capitalize tracking-widest rounded-lg transition-colors">Dismiss</button>
      </div>
    </motion.div>
  );
}
  ...
  if (loadingUser) {
    return (
      <div className="p-8 flex items-center justify-center min-h-[300px]">
        <div className="px-8 py-3 bg-slate-100 text-slate-400 font-black text-[10px] capitalize tracking-[0.4em] animate-pulse">
          Exchanging
        </div>
      </div>
    );
            ...
            {(mpUser && (!forcedTab || (forcedTab === 'my-listings' && mpUser.role === 'seller') || (forcedTab === 'buy-orders' && mpUser.role === 'buyer') || (forcedTab === 'advertising' && mpUser.role === 'seller'))) ? (
              <div className="flex items-center gap-4 flex-shrink-0">
                <div className="text-right">
                  <p className="font-black text-sm capitalize tracking-tighter">{mpUser.name}</p>
                  <p className={`${mpUser.role === 'buyer' ? 'text-blue-200' : 'text-emerald-200'} text-[9px] capitalize tracking-widest font-black`}>{mpUser.role} · {mpUser.district}</p>
                </div>
                <button onClick={handleLogout} className="px-3 py-1.5 bg-white/20 hover:bg-white/30 rounded-xl transition-colors text-[9px] font-black capitalize tracking-widest">
                  Logout
                </button>
              </div>
            ) : (
              <div className="flex gap-2 flex-shrink-0">
                {(activeTab === 'my-listings' || forcedTab === 'my-listings' || !forcedTab) && (
                  <button
                    ...
                    className="bg-white/20 hover:bg-white/30 px-4 py-2 rounded-xl text-[10px] font-black capitalize tracking-[0.2em] transition-colors"
                  >
                    Login as Seller
                  </button>
                )}
                {(activeTab === 'buy-orders' || forcedTab === 'buy-orders' || !forcedTab) && (
                  <button
                    ...
                    className={`${(forcedTab === 'buy-orders' || activeTab === 'buy-orders') ? 'bg-white text-blue-600 hover:bg-blue-50' : 'bg-white text-emerald-700 hover:bg-emerald-50'} px-4 py-2 rounded-xl text-[10px] font-black capitalize tracking-[0.2em] transition-colors`}
                  >
                    Login as Buyer
                  </button>
                )}
          ...
          <div className="flex gap-1 p-2 bg-slate-50 overflow-x-auto">
            {([
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl text-[10px] font-black capitalize tracking-widest transition-all whitespace-nowrap ${activeTab === tab.key
            ...
            <button onClick={fetchAll} className="px-3 py-2 text-[9px] font-black text-slate-400 hover:text-emerald-600 hover:bg-white rounded-xl transition-colors capitalize tracking-widest" title="Refresh">
              {loadingData ? '...' : 'Sync'}
            </button>
          </div>
        )}
            ...
            <div className="space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-3 px-1">
                  <h4 className="font-black text-slate-400 capitalize tracking-widest text-[10px]">
                    Available Listings
                  </h4>
                  {mpUser?.role === 'seller' && (
                    <button
                      ...
                      className="bg-emerald-600 text-white px-4 py-2 rounded-xl text-[10px] font-black capitalize tracking-widest hover:bg-emerald-700 transition-colors"
                    >
                      New Listing
                    </button>
                  )}
                  {!mpUser && (
                    <button onClick={() => { setAuthRole('seller'); setShowAuthModal(true); }}
                      className="text-[10px] text-emerald-600 font-black capitalize tracking-widest hover:underline">
                      Sell your crops
                    </button>
                  )}
                </div>
                ...
                {listings.length === 0 ? (
                  <div className="text-center py-12 text-slate-400 bg-slate-50/50 rounded-2xl">
                    <p className="text-[10px] font-black capitalize tracking-widest">No Active Output</p>
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3 flex-shrink-0">
                          ...
                          {(!mpUser || mpUser.role === 'buyer') ? (
                            ...
                            <span className="text-[10px] font-black capitalize tracking-widest text-slate-400">Buyer account only</span>
                          )}
                        </div>
                      </motion.div>
                    ))}
              ...
              <div>
                <div className="flex items-center justify-between mb-3 px-1">
                  ...
                  {mpUser?.role === 'buyer' && (
                    <button onClick={() => { setPrefillCrop(''); setShowAddBuyOrder(true); }}
                      className="bg-blue-600 text-white px-4 py-2 rounded-xl text-[10px] font-black capitalize tracking-widest hover:bg-blue-700 transition-colors">
                      New Order
                    </button>
                  )}
                  {!mpUser && (
                    <button onClick={() => { setAuthRole('buyer'); setShowAuthModal(true); }}
                      className="text-[10px] text-blue-600 font-black capitalize tracking-widest hover:underline">
                      Post a buy order
                    </button>
                  )}
                </div>
                ...
                {buyOrders.length === 0 ? (
                  <div className="text-center py-12 text-slate-400 bg-slate-50/50 rounded-2xl">
                    <p className="text-[10px] font-black capitalize tracking-widest">No Active Demand</p>
                  ...
                  <div className="space-y-2.5">
                    {buyOrders.map((order) => (
                      ...
                      >
                        <div className="flex items-center gap-3 min-w-0">
                          <div className="w-10 h-10 bg-blue-100 rounded-xl flex items-center justify-center text-blue-700 font-black text-[9px] capitalize tracking-tighter flex-shrink-0">
                            BUY
                          </div>
                          <div className="min-w-0">
                            <p className="font-black text-slate-900 text-sm capitalize tracking-tighter">{order.crop}</p>
                            <p className="text-[10px] text-slate-500 font-bold capitalize tracking-widest">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-[9px] text-blue-700 font-black capitalize tracking-widest">MAX {order.currency} {order.max_price_per_kg.toLocaleString()}</p>
                        </div>
                      </motion.div>
                    ))}
                  </div>
            ...
            <div>
              {!mpUser ? (
                ...
                <div className="text-center py-16 bg-slate-100">
                  <p className="text-slate-500 font-black capitalize text-[10px] tracking-widest">Subscription Required</p>
                  ...
                  <button onClick={() => setActiveTab('advertising')} className="mt-6 bg-slate-900 text-white px-8 py-3 font-black capitalize text-[10px] tracking-widest">Go to Subscription</button>
                </div>
              ) : (
                <>
                  <div className="flex items-center justify-between mb-8 px-2">
                    <div>
                      <h4 className="text-[11px] font-black text-slate-400 capitalize tracking-[0.3em] mb-1">Managed Assets</h4>
                      <p className="text-2xl font-black text-slate-950 capitalize tracking-tighter">{myListings.length} Active Listings</p>
                    </div>
                    <button onClick={() => setShowAddListing(true)}
                      className="bg-emerald-600 text-white px-6 py-3 rounded-2xl text-[10px] font-black capitalize tracking-[0.2em] hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-500/20 active:scale-95">
                      + Add New Asset
                    </button>
                  </div>
                  ...
                  {myListings.length === 0 ? (
                    <div className="text-center py-20 bg-slate-50 rounded-[2.5rem] border-2 border-dashed border-slate-200 mb-12">
                      ...
                      <p className="text-[10px] font-black capitalize tracking-[0.3em] text-slate-400 mb-2">Inventory Empty</p>
                      <p className="text-sm font-bold text-slate-600 mb-8">Your commercial output will appear here</p>
                      <button onClick={() => setShowAddListing(true)} className="text-emerald-600 font-black text-[10px] capitalize tracking-widest hover:underline">Initialize First Listing</button>
                    </div>
                  ) : (
                    <div className="overflow-x-auto rounded-none border border-slate-200 bg-white shadow-sm mb-12">
                      <table className="min-w-full border-separate border-spacing-y-3">
                        <thead>
                          <tr className="bg-[#8B4513] capitalize tracking-[0.25em] text-[9px] text-white/90">
                            ...
                            <tr key={listing.id} className="bg-white border-b border-slate-100 hover:bg-slate-50 transition-colors">
                              <td className="px-5 py-4 align-top">
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    <p className="font-black text-slate-900 capitalize tracking-tight">{listing.crop}</p>
                                    <p className="text-[10px] text-slate-500 capitalize tracking-[0.25em]">SKU {listing.id.slice(0, 8)}</p>
                                  </div>
                                </div>
                              </td>
                              <td className="px-5 py-4 align-top">
                                <p className="font-black text-slate-900">{listing.quantity_kg.toLocaleString()} KG</p>
                                <p className="text-[10px] text-slate-500 capitalize tracking-[0.25em]">Available</p>
                              </td>
                              <td className="px-5 py-4 align-top">
                                <p className="font-black text-emerald-600">{listing.currency} {listing.price_per_kg.toLocaleString()}</p>
                              </td>
                              <td className="px-5 py-4 align-top">
                                <span className={`px-3 py-1 rounded-full text-[10px] font-black capitalize tracking-[0.2em] ${listing.status === 'active' ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-500'}`}>
                                  {listing.status}
                                </span>
                              </td>
                              <td className="px-5 py-4 align-top text-[10px] text-slate-500 capitalize tracking-[0.25em]">
                                {format(new Date(listing.created_at), 'dd MMM yyyy')}
                              </td>
                              <td className="px-5 py-4 align-top">
                                <button onClick={() => cancelListing(listing.id)}
                                  className="px-4 py-2 text-[10px] font-black capitalize tracking-[0.2em] text-red-500 border border-red-100 rounded-2xl hover:bg-red-50 transition-colors">
                                  Remove
                                </button>
                              </td>
                            </tr>
                  ...
                  <div className="mt-16 pt-12 border-t border-slate-100">
                    <div className="flex items-center justify-between mb-8 px-2">
                      <div>
                        <h4 className="text-[11px] font-black text-emerald-600 capitalize tracking-[0.3em] mb-1">Live Demand</h4>
                        <p className="text-2xl font-black text-slate-900 capitalize tracking-tighter">Opportunities to Fulfill</p>
                      </div>
                    </div>

                    {buyOrders.filter(o => o.buyer_id !== mpUser?.id).length === 0 ? (
                      <div className="text-center py-12 bg-slate-50/50 rounded-[2rem]">
                        <p className="text-[10px] font-black capitalize tracking-widest text-slate-400">No external demand found</p>
                      </div>
                    ) : (
                      <div className="space-y-3">
                        {buyOrders.filter(o => o.buyer_id !== mpUser?.id).map(order => (
                          <div key={order.id} className="flex items-center justify-between p-5 bg-slate-50 rounded-[1.5rem] border border-transparent hover:border-emerald-200 transition-all group">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                <p className="font-black text-slate-950 capitalize tracking-tighter leading-none mb-1">{order.crop}</p>
                                <p className="text-[10px] text-slate-500 font-bold capitalize tracking-widest">
                            ...
                            <div className="text-right">
                              ...
                              <p className="text-[9px] font-black text-emerald-600 capitalize tracking-widest">Max Budget</p>
                            </div>
                          </div>
                        ))}
                      </div>
          ...
          {activeTab === 'buy-orders' && (
            <div>
              {!mpUser ? (
                <div className="text-center py-16">
                  <p className="text-[10px] font-black text-slate-400 capitalize tracking-widest mb-4">Authentication Required</p>
                  <button onClick={() => { setAuthRole('buyer'); setShowAuthModal(true); }} className="bg-blue-600 text-white px-8 py-3 rounded-xl font-black capitalize text-[10px] tracking-widest">Log in as Buyer</button>
                </div>
              ) : mpUser.role !== 'buyer' ? (
                <div className="text-center py-16">
                  <p className="text-[10px] font-black text-slate-400 capitalize tracking-widest mb-4">Buyer Account Required</p>
                  <button onClick={() => { setAuthRole('buyer'); setShowAuthModal(true); }} className="bg-blue-600 text-white px-8 py-3 rounded-xl font-black capitalize text-[10px] tracking-widest">Log in as Buyer</button>
                </div>
              ) : (
                <>
                  <div className="flex items-center justify-between mb-8 px-2">
                    <div>
                      <h4 className="text-[11px] font-black text-slate-400 capitalize tracking-[0.3em] mb-1">Procurement Queue</h4>
                      <p className="text-2xl font-black text-slate-950 capitalize tracking-tighter">{myBuyOrders.length} Open Orders</p>
                    </div>
                    <button onClick={() => { setPrefillCrop(''); setShowAddBuyOrder(true); }}
                      className="bg-blue-600 text-white px-6 py-3 rounded-2xl text-[10px] font-black capitalize tracking-[0.2em] hover:bg-blue-700 transition-all shadow-xl shadow-blue-500/20 active:scale-95">
                      + Create Purchase Req
                    </button>
                  </div>
                  ...
                  {myBuyOrders.length === 0 ? (
                    <div className="text-center py-20 bg-slate-50 rounded-[2.5rem] border-2 border-dashed border-slate-200 mb-12">
                      ...
                      <p className="text-[10px] font-black capitalize tracking-[0.3em] text-slate-400 mb-2">Queue Empty</p>
                      <p className="text-sm font-bold text-slate-600 mb-8">Your crop requirements will appear here</p>
                      <button onClick={() => { setPrefillCrop(''); setShowAddBuyOrder(true); }} className="text-blue-600 font-black text-[10px] capitalize tracking-widest hover:underline">Post Initial Requirement</button>
                    </div>
                  ) : (
                      ...
                      {myBuyOrders.map(order => (
                        <div key={order.id} className="group relative bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl hover:border-blue-200 transition-all duration-500 overflow-hidden">
                          <div className="absolute top-0 right-0 p-4">
                            <span className={`px-3 py-1 rounded-full text-[8px] font-black capitalize tracking-widest ${order.status === 'open' ? 'bg-blue-100 text-blue-700' : 'bg-slate-100 text-slate-500'}`}>
                              {order.status}
                            </span>
                          </div>
                          <div className="flex items-start gap-4 mb-6">
                            ...
                            <div>
                              <h5 className="text-lg font-black text-slate-900 capitalize tracking-tighter leading-none mb-1">{order.crop}</h5>
                              <p className="text-[10px] font-black text-slate-400 capitalize tracking-widest">REQ: {order.id.slice(0, 8)}</p>
                            </div>
                          </div>
                          <div className="grid grid-cols-2 gap-4 p-4 bg-slate-50 rounded-2xl mb-6">
                            <div>
                              <p className="text-[9px] font-black text-slate-400 capitalize tracking-widest mb-1">Target Vol</p>
                            ...
                            <div>
                              <p className="text-[9px] font-black text-slate-400 capitalize tracking-widest mb-1">Max Price</p>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            {order.status === 'open' && (
                              <button onClick={() => cancelBuyOrder(order.id)}
                                className="px-4 py-2 text-[9px] font-black text-red-400 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all capitalize tracking-widest">
                                Revoke Request
                              </button>
                            )}
                          </div>
                  ...
                  <div className="mt-16 pt-12 border-t border-slate-100">
                    <div className="flex items-center justify-between mb-8 px-2">
                      <div>
                        <h4 className="text-[11px] font-black text-blue-600 capitalize tracking-[0.3em] mb-1">Market Discovery</h4>
                        <p className="text-2xl font-black text-slate-900 capitalize tracking-tighter">Available for Purchase</p>
                      </div>
                    </div>

                    {listings.length === 0 ? (
                      <div className="text-center py-12 bg-slate-50/50 rounded-[2rem]">
                        <p className="text-[10px] font-black capitalize tracking-widest text-slate-400">No external listings found</p>
                      </div>
                    ) : (
                      <div className="space-y-3">
                          ...
                          <div key={listing.id} className="flex items-center justify-between p-5 bg-slate-50 rounded-[1.5rem] border border-transparent hover:border-blue-200 transition-all group">
                            ...
                            <div className="flex items-center gap-4">
                              <div className="text-right">
                                ...
                                <p className="text-[9px] font-black text-blue-600 capitalize tracking-widest">Asking Price</p>
                              </div>
                              <button
                                onClick={() => {
                                  setPrefillCrop(listing.crop);
                                ...
                                className="bg-blue-600 text-white px-4 py-2 rounded-xl text-[10px] font-black capitalize tracking-widest hover:bg-blue-700 transition-all active:scale-95"
                              >
                                Buy
                              </button>
                            </div>
            ...
            <div>
              ...
              {(() => {
                ...
                if (trades.length === 0) {
                  return (
                    <div className="text-center py-16 text-slate-400 bg-slate-50 rounded-2xl">
                      <p className="text-[10px] font-black capitalize tracking-widest">No Trade Activity</p>
                ...
                if (filtered.length === 0) {
                  return (
                    <div className="text-center py-16 text-slate-400 bg-slate-50 rounded-2xl">
                      <p className="text-[10px] font-black capitalize tracking-widest">No Results Found</p>
                    ...
                    <table className="w-full text-left">
                      <thead className="bg-[#8B4513] text-white">
                        <tr className="bg-white/10">
                          <th className="px-6 py-4 text-[10px] font-black capitalize tracking-widest text-emerald-50 text-left">Crop</th>
                          <th className="px-6 py-4 text-[10px] font-black capitalize tracking-widest text-emerald-50 text-left">Quantity</th>
                          <th className="px-6 py-4 text-[10px] font-black capitalize tracking-widest text-white text-left text-center">Total Value</th>
                          <th className="px-6 py-4 text-[10px] font-black capitalize tracking-widest text-blue-50 text-left">Parties</th>
                          <th className="px-6 py-4 text-[10px] font-black capitalize tracking-widest text-blue-50 text-left text-center">Status</th>
                          <th className="px-6 py-4 text-[10px] font-black capitalize tracking-widest text-blue-50 text-left">Completed On</th>
                          <th className="px-6 py-4 text-[10px] font-black capitalize tracking-widest text-blue-50 text-left">Action</th>
                        </tr>
                      </thead>
                      <tbody>
                        {filtered.map(trade => {
                          ...
                          return (
                            ...
                            >
                              <td className="px-6 py-4">
                                <span className="font-black text-slate-900 capitalize tracking-tight">{trade.crop}</span>
                              </td>
                              <td className="px-6 py-4">
                              ...
                              <td className="px-6 py-4">
                                <div className="flex flex-col gap-1.5">
                                  <div className="flex items-center gap-2">
                                    <span className="bg-emerald-100 text-emerald-700 text-[7px] font-black px-1.5 py-0.5 rounded capitalize tracking-tighter">Seller</span>
                                    <span className="text-[10px] font-black text-slate-900 capitalize truncate max-w-[100px]">{trade.seller_name}</span>
                                  </div>
                                  <div className="flex items-center gap-2">
                                    <span className="bg-blue-100 text-blue-700 text-[7px] font-black px-1.5 py-0.5 rounded capitalize tracking-tighter">Buyer</span>
                                    <span className="text-[10px] font-black text-slate-900 capitalize truncate max-w-[100px]">{trade.buyer_name}</span>
                                  </div>
                                </div>
                              </td>
                              <td className="px-6 py-4">
                                <span className={`px-2 py-0.5 text-[8px] font-black rounded capitalize tracking-widest ${trade.status === 'completed' ? 'bg-emerald-100 text-emerald-600' : 'bg-amber-100 text-amber-600'
                                  }`}>
                                  {trade.status}
                                </span>
                              </td>
                              ...
                              <td className="px-6 py-4">
                                {trade.status === 'pending' && isSeller && (
                                  <button
                                    ...
                                    className="bg-emerald-600 text-white px-3 py-1.5 rounded-xl text-[9px] font-black capitalize tracking-widest hover:bg-emerald-700 transition-all shadow-sm"
                                  >
                                    Finalize
                                  </button>
                                )}
                                {trade.status === 'pending' && !isSeller && (
                                  <span className="text-[9px] font-black text-slate-300 capitalize italic">Awaiting Seller</span>
                                )}
                                {trade.status === 'completed' && (
                                  <span className="text-emerald-500 font-black text-[9px] capitalize">Verified</span>
                                )}
                              </td>
                            </motion.tr>
                          );
              ...
              {!mpUser ? (
                ...
                <div className="space-y-6">
                  <div className="bg-emerald-50 rounded-2xl p-6 flex items-center justify-between">
                    <div>
                      <h3 className="text-lg font-black text-emerald-950 capitalize tracking-tighter">Advertising Dashboard</h3>
                      <p className="text-xs text-emerald-700 font-bold capitalize tracking-widest">Active · Verified Account</p>
                    </div>
                    <div className="bg-emerald-500 text-white px-4 py-2 rounded-xl text-[10px] font-black capitalize tracking-widest shadow-lg shadow-emerald-500/20">
                      Featured Seller
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="bg-white p-6 rounded-2xl shadow-sm">
                      <p className="text-[10px] font-black text-slate-400 capitalize tracking-widest mb-2">Ad Impressions</p>
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm">
                      <p className="text-[10px] font-black text-slate-400 capitalize tracking-widest mb-2">Clicks/Inquiries</p>
                  ...
                  <div className="bg-slate-900 rounded-2xl p-8 text-white relative overflow-hidden">
                    <div className="relative z-10">
                      <h4 className="text-xl font-black capitalize tracking-tighter mb-4">Promote a Listing</h4>
